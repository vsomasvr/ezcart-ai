...
public class McpSyncClientExchangeFilterFunction implements ExchangeFilterFunction {
    ...
    private static final String TOKEN_EXCHANGE_CLIENT_REGISTRATION_ID = "ezcart-ai-mcp-call-dev";
    private static final String CLIENT_CREDENTIALS_CLIENT_REGISTRATION_ID = "ezcart-ai-mcp-list-dev";
    ...
    public McpSyncClientExchangeFilterFunction(OAuth2AuthorizedClientManager clientManager,
        ...
        this.delegate.setDefaultClientRegistrationId(TOKEN_EXCHANGE_CLIENT_REGISTRATION_ID);
