...
public class MultiToolAgent {
    ...
    public static String USER_ID = "student";
    public static String NAME = "multi_tool_agent";
    ...
    public static BaseAgent initAgent() {
        return LlmAgent.builder()
                ...
                .instruction("You are a helpful agent who can answer user questions about the time and weather"
                        + " in a city.").tools(FunctionTool.create(MultiToolAgent.class, "getCurrentTime"),
    ...
    public static Map<String, String> getCurrentTime(
        ...
        return ZoneId.getAvailableZoneIds()
                ...
                .findFirst().map(zid -> Map.of("status", "success", "report", "The current time in "
                        + city + " is " + ZonedDateTime.now(ZoneId.of(zid))
                        .format(DateTimeFormatter.ofPattern("HH:mm")) + "."))
                .orElse(Map.of("status", "error", "report", "Sorry, I don't have timezone information for "
                        + city + "."));
    }
    ...
    public static Map<String, String> getWeather(
        ...
        if (city.toLowerCase().equals("new york")) {
            ...
            return Map.of("status", "error", "report", "Weather information for "
